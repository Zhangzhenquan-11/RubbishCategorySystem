...
<div class="row">
		...
		<div class="col-md-9 col-xs-12">
			<div class="row">
				...
				<div class="col-md-12 col-xs-12">${rubbishCategory.require }</div>
			</div>
		</div>
</div>
<br>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-9 col-xs-12" style="color:#787878">
        友情链接:
        <a href="https://baike.baidu.com/item/垃圾分类/2904193?fr=aladdin">垃圾分类百度百科</a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-1 col-xs-0"></div>
      <div class="col-md-9 col-xs-12">
        <p style="color:#787878">Copyright 2019 - 2020 
        	<a href="/RubbishCategory/home/search">垃圾分类</a>|
